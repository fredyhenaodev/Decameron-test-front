          ...
          <Hidden smDown>
            <div className={classes.headerProperties}>
              <div className={classNames(classes.headerAction, classes.invert)}>
                {fullScreen ? (
                  <Tooltip title="Salir Pantalla Completa" placement="bottom">
                ...
                <Tooltip title="Activar modo Claro/Oscuro" placement="bottom">
                  <IconButton className={classes.button} onClick={() => this.turnMode(mode)}>
                    <Ionicon icon="ios-bulb-outline" />
                  </IconButton>
                </Tooltip>
                <Tooltip title="TV" placement="bottom">
                  <IconButton className={classes.button} onClick={(e) => this.handleRoute(e,'/app/tv')}>
                    <Ionicon icon="ios-videocam" />
                  </IconButton>
                </Tooltip>
                <Tooltip title="Radio" placement="bottom">
                  <IconButton className={classes.button} onClick={(e) => this.handleRoute(e,'/app/radio')}>
                    <Ionicon icon="ios-radio-outline" />
                  </IconButton>
                </Tooltip>
              </div>
            </div>
